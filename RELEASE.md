...
1. **CHANGELOG** — Move items from `[Unreleased]` to a dated section; set the version heading (e.g. `## [1.0.1] - YYYY-MM-DD`).
...
5. **Tag** — `git tag -a v1.0.0 -m "Release v1.0.0"` and push tags.

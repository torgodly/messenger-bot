...
1. **CHANGELOG** — Move items from `[Unreleased]` to a dated section; set the version heading (e.g. `## [1.1.0] - YYYY-MM-DD`).
...
5. **Tag** — `git tag -a v1.1.0 -m "Release v1.1.0"` and push tags.

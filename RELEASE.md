...
1. **CHANGELOG** — Move items from `[Unreleased]` to a dated section; set the version heading (e.g. `## [2.0.0] - YYYY-MM-DD`).
...
5. **Tag** — `git tag -a v2.0.0 -m "Release v2.0.0"` and push tags.
